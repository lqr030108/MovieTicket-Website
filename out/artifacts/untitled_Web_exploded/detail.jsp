...
<%@page import="com.xxxx.controller.CustomDateConverter"%>
<%@page import="org.springframework.ui.Model"%>
<%@page import="java.util.List"%>
<%@page import="com.xxxx.entity.*"%>
...
<div class="banner"  style="background: #848499" >
    <div class="wrapper clearfix">
        <div class="celeInfo-left">
            <div class="avater-shadow">
                <img class="avater" src=${mov_detail.image }>
                <div class="movie-ver"></div>
            </div>
        </div>
        <div class="celeInfo-right clearfix">
            <div class="movie-brief-container">
                <h3 class="name">${mov_detail.movName }</h3>
                <ul>
                    <li class="ellipsis">${mov_detail.type }</li>
                   
                    
                    <li class="ellipsis">${mov_detail.runningtime }分钟</li>
                    <li class="ellipsis"><fmt:formatDate value="${mov_detail.showtime }" pattern="yyyy-MM-dd"/>大陆上映</li>
                <button class="btn btn-danger btn-lg" onclick="window.location.href='showSession?mov_id=${mov_detail.id}'">购票选座</button>
                </ul>
            </div>
                ...
                <div class="movie-index">
                    ...
                    <div class="movie-index-content score normal-score">
                        <span class="index-left info-num ">
                            <span class="stonefont">${mov_detail.totalScore }</span>
                        </span>
        ...
        <div class="bs-docs-section">
            ...
            <div class="tab-content-container">
                <div class="tab-desc tab-content active">
                    <p id="actor">
                        <span class="dra">${mov_detail.introduction }</span>
                    </p>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2 col-md-2">
                            <div class="thumbnail" style="border: transparent">
                                ...
                                <div class="caption">
                                    <p class="text-center">${mov_detail.director }</p>
                                </div>
                            </div>
                        </div>
                        <%
            ...
            <div class="module">
                ...
                <div class="mod-content">
                 <%
                  ...
                  List<User> cliList = (List<User>)session.getAttribute("comCliList");
                 %>
