<%@page import="com.xxxx.entity.orders"%>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid" style="background: #161C29">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav">
                <br>
                <li class="active" style="font-size: medium;color: white">${user.userName}的订单</li>
            </ul>
...
<div id="sort_search" >
		<a href="index.jsp" style="background: #161C29" id="add_movie">返回首页</a>
</div>
	<div id="thead" >
		<table class="public">
			<tr>
