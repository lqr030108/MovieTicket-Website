...
$("#orderbtn").click(function (){
	location.href = "submitorder?rowId_1="+rows[0]+"&columnId_1="+cols[0]+"&rowId_2="+rows[1]+"&columnId_2="+cols[1]+"&rowId_3="+rows[2]+"&columnId_3="+cols[2]+"&rowId_4="+rows[3]+"&columnId_4="+cols[3];
